...
[11]= {"Lirik","lirikThump","lirikC","lirikB","lirikL","lirikM","lirikW","lirikF","lirikO","lirikFAT","lirikAppa","lirikGasm","lirikRage","lirikGOTY","lirikREKT","lirikHYPE","lirikRIP","lirikD","lirikWc","lirikPVP","lirikH","lirikTRASH","lirikMLG","lirikCLENCH","lirikDEAD","lirikCRASH","lirikHug","lirikCRY","lirikTEN","lirikPOOP","lirikNICE"},
[12]= {"Liveplayging","boomerDrink","boomerKappe","boomerKrone","boomerBoomerMosta","boomerBoomerStapler","boomerPizza","boomerGlantz","boomerMinus","boomerInc","boomerSabotage"},
[13]= {"Mufasaprime","primeBeard","primeKappa","primeLaugh","primeLoot","primeScum","primeCoin","primeSquid","primeFeel"},
[14]= {"Nl_kripp","krippRage","krippDonger","krippRiot","krippDonger2","krippDoge","krippOJ","krippChamp","krippSheffy","krippGive","krippThump","krippSleeper","krippWTF","krippWall","krippSuccy","krippCat","krippBird","krippFist","krippW","krippToon","krippLucky","krippEye"},
[15]= {"Nmplol","nmpNMPbomb","nmpSweg","nmpTHELORD","nmpTUDI","nmpSAD","nmpThump","nmpKerpa","nmpW"},
[16]= {"other1","4Head","ANELE","KappaPride","ArsonNoSexy","AsianGlow","AtGL","AthenaPMS","AtIvy","AtWW","BabyRage","BatChest","BCWarrior","BibleThump","BigBrother","BionicBunion","BlargNaut","BloodTrail","BORT","BrainSlug","BrokeBack","BuddhaBar","CougarHunt","DAESuppy","DansGame","DatSheffy","DBstyle","DendiFace","DogFace","EagleEye","EleGiggle","EvilFetus"},
...
[18]= {"other3","KZskull","Mau5","mcaT","MechaSupes","MrDestructoid","MVGame","NightBat","NinjaTroll","NoNoSpot","noScope","NotAtk","OMGScoots","OneHand","OpieOP","OptimizePrime","panicBasket","PanicVis","PazPazowitz","PeoplesChamp","PermaSmug","PicoMause","PipeHype","PJHarley","PJSalt","PMSTwin","PogChamp","Poooound","PraiseIt","PRChase","PunchTrees","PuppeyFace","RaccAttack","RalpherZ","RedCoat","ResidentSleeper","RitzMitz","RuleFive","Shazam","shazamicon","ShazBotstix","ShibeZ","SMOrc","SMSkull","SoBayed","SoonerLater","SriHead","SSSsss","StoneLightning","StrawBeary","SuperVinlin","SwiftRage","TF2John","TheRinger","TheTarFu","TheThing","ThunBeast","TinyFace","TooSpicy","TriHard","TTours","UleetBackup","UncleNox","UnSane","Volcania","WholeWheat","WinWaker","WTRuck","WutFace","YouWHY"},
[19]= {"Pingwingtv","pingCoon","pingApproves","pingNana","pingOh","pingShiny","pingStar","pingW","pingKappa"},
[20]= {"Rabbitbong","thatWhiteKnight","thatScumbag","thatBob","thatThirst","thatSwine","thatKawaii","thatDemMelons","thatLOL"},
[21]= {"Reckful","reckS","reckTime","reckDDOS","reckHello","reckCry","reckSleeper","reckDealer","reckJew","reckJenna","reckFarmer","reckRiot","reckD","reckT","reckSND","reckW"},
...
[27]= {"Towelliee","towSkinTowel","towVACBOSS","towBANNED","towHAMUP","towOface","towShappens","towBolvar","towPalm","towKappa","towByah","towPoop","towRage","towShots","towWtf","towThump","towTrain","towDerp","towBeer","towRekt","towRip","towJoe","towJesus","towW","towAim"},
[28]= {"Vanguardstv","vanGoHAM","vanHOJ","vanKwok","vanWings"},
[29]= {"Venruki","rukiDownGoes","rukiCanadaEh","rukiHarryKappa","rukiSmug","rukiAdult","rukiDoYou","rukiBuddy","rukiPunch","rukiWot","rukiGasm","rukiAmigo","rukiCry","rukiDerp","rukiTea","rukiCreep","rukiWizRuki"},
[30]= {"Watchmeblink1","mitchHi-Yah","mitchKamehameha","mitchTheLaw","mitchDood","mitchTyrone","mitchLipstick","mitchYoloBlock","mitch1","mitchDewkappa","mitchAbort","mitchDream","mitchCall","mitchQuest","mitchW","mitchMitchEw","mitchWW"},
[31]= {"Woundman","woundFace","woundGrin","woundGasm","woundJJ","woundBomb","woundOil"},
[32]= {"xentaria","xentiSabotage","xentiShrimp","xentiRBG","xentiBox"},
[33]= { "BTTV", "BasedGod","cabbag3","CiGrip","ConcernDoge","CookieThump","FapFapFap","FishMoley","ForeverAlone","FuckYea","HerbPerve", "Hhehehe","KKona","NaM","OhhhKee","Parappappa","PedoBear","PedoNam","PokerFace","RageFace","RebbecaBlack","rStrike","ShoopDaWhoop", "tEh","TrollFace","TwaT","VisLaud","WatChuSay","GabeN","AngelThump","FeelsBadMan","FeelsGoodMan","GoldGasm"},
[34]= { "Custom","CoolCat","deIlluminati","DOOMGuy","duDudu","hotShield","hotSword","modzHype","modzREKT","OSfrog","trumpGive","VaultBoy","ppdUSA"},
[35]= { "Test","CoolCat","deIlluminati","DOOMGuy","duDudu","hotShield","hotSword","modzHype","modzREKT","OSfrog","trumpGive","VaultBoy","ppdUSA"},
}; 
