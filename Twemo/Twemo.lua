...
[13]= {"Nl_kripp","krippRage","krippDonger","krippRiot","krippDonger2","krippDoge","krippOJ","krippChamp","krippSheffy","krippGive","krippThump","krippSleeper","krippWTF","krippWall","krippSuccy","krippCat","krippBird","krippFist","krippW","krippToon","krippLucky","krippEye","krippO","krippFat"},
...
[18]= {"other4","mitchPleb","SeemsGood","twitchRaid","VapeNation","mito100","mitoOK"},
...
[22]= {"Reynad", "reynadRappa","reynadBeer","reynadW","reynadA","reynadH","reynadB","reynadC","reynadTS","reynadLeft","reynadRight","reynadGF","reynadSkill"},
...
[29]= {"Woundman","woundFace","woundGrin","woundGasm","woundJJ","woundBomb","woundOil"},
[30]= {"xentaria","xentiSabotage","xentiShrimp","xentiRBG","xentiBox"},
[31]= {"BTTV","BasedGod","cabbag3","CiGrip","ConcernDoge","CookieThump","FapFapFap","FishMoley","ForeverAlone","FuckYea","HerbPerve","Hhehehe","KKona","NaM","OhhhKee","Parappappa","PedoBear","PedoNam","PokerFace","RageFace","RebbecaBlack","rStrike","ShoopDaWhoop","tEh","TrollFace","TwaT","VisLaud","WatChuSay","GabeN","AngelThump","FeelsBadMan","FeelsGoodMan","bUrself","LUL","haHAA"},
[32]= {"Trihex","tri1","tri2","tri3","tri4","triCheese","triDANK","triDookie","triGasm","triGiggle","triGropeL","triGropeR","triLewd","triPantsu","triSpaghetti","triSugoi","triTHIRST","triUGH","triURRP","triWaifu","triWAT"},
[33]= {"Xindra","CoolCat","deIlluminati","DOOMGuy","duDudu","hotShield","hotSword","modzHype","modzREKT","OSfrog","trumpGive","VaultBoy","ppdUSA","GoldGasm","cmonBruh","CorgiDerp",},
[34]= {"Auto","NotLikeThis","BCouch","MingLee","OhMyDog","demAsap"},
}; 
