...
[17]= {"other1","4Head","ANELE","ArsonNoSexy","AsianGlow","AtGL","AthenaPMS","AtIvy","AtWW","BabyRage","BatChest","BCWarrior","BibleThump","BigBrother","BionicBunion","BlargNaut","BloodTrail","BORT","BrainSlug","BrokeBack","BuddhaBar","CougarHunt","DAESuppy","DansGame","DatSheffy","DBstyle","DendiFace","DogFace","EagleEye","EleGiggle","EvilFetus"},
...
[34]= { "BTTV", "BasedGod","cabbag3","CiGrip","ConcernDoge","CookieThump","FapFapFap","FishMoley","ForeverAlone","FuckYea","HerbPerve", "Hhehehe","KKona","NaM","OhhhKee","Parappappa","PedoBear","PedoNam","PokerFace","RageFace","RebbecaBlack","rStrike","ShoopDaWhoop", "tEh","TrollFace","TwaT","VisLaud","WatChuSay"},
[35]= { "Night","Batappa","DogeWitIt","Kaged","SoSerious"},
}; 
